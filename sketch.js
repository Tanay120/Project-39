  ...
  function setup(){
    ...
    ground=createSprite(300,180,6000000000000000000000,5)
    ground.addImage("groundImage",groundImage)
    
    //creating edge sprites
    edges=createEdgeSprites();

    invisibleBarrier= createSprite(200,20,600000000000000000,5);

    //Making the sprite invisible
    invisibleBarrier.visible=false;

    //To make the Trex walk inside the ground
    invisibleGround= createSprite(200,190,1000000000000000000,5);
